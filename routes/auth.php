...
Route::middleware(['auth'])->group(function () {
    Route::get('settings/profile', App\Livewire\SettingsProfile::class)->name('settings.profile.edit');
    Route::get('settings/password', App\Livewire\SettingsPassword::class)->name('settings.password.edit');
});
